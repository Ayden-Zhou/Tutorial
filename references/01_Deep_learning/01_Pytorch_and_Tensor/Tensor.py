...
# These constants were originally imported from a project-local helper module.
# Inline them here so this reference script can run standalone.
a100_flop_per_sec = 312e12
h100_flop_per_sec = 1979e12 / 2  # dense FP16/BF16 peak used later in the note
