...
# %%
%%writefile collective_ops_demo.py
import torch
import torch.distributed as dist
...
# %%
%%writefile benchmark_reduce_scatter_demo.py
import time
import torch
import torch.distributed as dist
from parallel_utils import setup, cleanup, get_device, render_duration
...
# %%
%%writefile data_parallel_demo.py
import torch
import torch.nn.functional as F
import torch.distributed as dist
...
# %%
%%writefile tensor_parallel_demo.py
import torch
import torch.nn.functional as F
import torch.distributed as dist
from parallel_utils import setup, cleanup, get_device, int_divide, get_init_params, summarize_tensor
...
# %%
%%writefile pipeline_parallel_demo.py
import torch
import torch.nn.functional as F
import torch.distributed as dist
from parallel_utils import setup, cleanup, get_device, int_divide, get_init_params, summarize_tensor
